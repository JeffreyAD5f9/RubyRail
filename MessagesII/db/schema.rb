...
ActiveRecord::Schema.define(version: 20170609191058) do
  ...
  add_index "poly_comments", ["commentable_type", "commentable_id"], name: "index_poly_comments_on_commentable_type_and_commentable_id"
